...
![横轴表示了不同的划分参数n，纵轴表示给定n条件下，能得到最优值的频数](https://cos.name/wp-content/uploads/2012/03/result01.jpeg)
...
![横轴为不同的划分参数n，纵轴表示10000次模拟的期望值](https://cos.name/wp-content/uploads/2012/03/result02.jpeg)
...
![进行对象选取的一万次模拟，每次模拟返回选取对象所需要的尝试次数，0表示未能得到任何对象，1表示在观察七个对象后，只需要一次尝试就得到较优的对象。](https://cos.name/wp-content/uploads/2012/03/result03.jpeg)
